<template>
	<view class="uni-load-more" @click="onClick">
		...
		<svg width="24" height="24" viewBox="25 25 50 50" v-if="!webviewHide && (iconType==='circle' || iconType==='auto' && platform === 'android') && status === 'loading' && showIcon" :style="{width:iconSize+'px',height:iconSize+'px'}" class="uni-load-more__img uni-load-more__img--android-H5">
			<circle class="uni-load-more__img--android-H5-circle" cx="50" cy="50" r="20" fill="none" :style="{color:color}" :stroke-width="3"></circle>
		</svg>
		<!-- #endif -->
		<!-- #ifndef APP-NVUE || H5 -->
		<view v-if="!webviewHide && (iconType==='circle' || iconType==='auto' && platform === 'android') && status === 'loading' && showIcon" :style="{width:iconSize+'px',height:iconSize+'px'}" class="uni-load-more__img uni-load-more__img--android-MP">
			<view :style="{borderTopColor:color,borderTopWidth:iconSize/12}" class="uni-load-more__img--android-MP-view MP-view1"></view>
			<view :style="{borderTopColor:color,borderTopWidth:iconSize/12}" class="uni-load-more__img--android-MP-view MP-view2"></view>
			<view :style="{borderTopColor:color,borderTopWidth:iconSize/12}" class="uni-load-more__img--android-MP-view MP-view3"></view>
		</view>
		<!-- #endif -->
		<!-- #ifndef APP-NVUE -->
